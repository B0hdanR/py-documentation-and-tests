...
class AuthenticatedMovieAPITests(TestCase):
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_user(
            email="test@test.test", password="test123456"
        )
        self.client.force_authenticate(self.user)
    ...
    def test_filter_movies_by_actors(self):
        ...
        movie_with_actor_1 = sample_movie(title="Movie1")
        movie_with_actor_2 = sample_movie(title="Movie2")
    ...
    def test_filter_movies_by_title(self):
        movie_with_title_1 = sample_movie(title="Movie1")
        movie_with_title_2 = sample_movie(title="Movie2")
        ...
        serializer_movie_with_title_1 = MovieListSerializer(movie_with_title_1)
        serializer_movie_with_title_2 = MovieListSerializer(movie_with_title_2)

        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertIn(serializer_movie_with_title_1.data, res.data)
        self.assertNotIn(serializer_movie_with_title_2.data, res.data)
        self.assertEqual(len(res.data), 1)

    def test_filter_movies_by_genre_and_title(self):
        movie_with_genre_1 = sample_movie(title="Movie1")
        movie_with_genre_2 = sample_movie(title="Movie2")
        genre_1 = Genre.objects.create(name="Genre1")
        genre_2 = Genre.objects.create(name="Genre2")
    ...
    def test_retrieve_movie_detail(self):
        movie = sample_movie()
        movie.actors.add(Actor.objects.create(first_name="Actor1Name", last_name="Actor1LastName"))
